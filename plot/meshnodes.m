...
% meshnodes.m wird von mesh0.m oder meshx.m fuer jedes Element einzeln aufgerufen.
% Als "Rueckgabewerte" werden die Variablen xplot, yplot (und zplot) erzeugt.
% Diese enthalten die Punktkoordinaten, die nach der Art des "Haus des Nikolaus"
% mit dem plot-Befehl nacheinander abgefahren werden, um die Elementkanten einzuzeichnen.
...
switch elem_nr
    ...
    case pyramid_5  % Pyramidenelement (5 Knoten)
        % Grundplatte zeichnen (Knotenreihenfolge 1-2-3-4-1)
        x_plot(1:4) = node(el(aktele,1:4),1) + ...
            defo_flag*defo_scal*unode(el(aktele,1:4),1);
        x_plot(5) = node(el(aktele,1),1) + ...
            defo_flag*defo_scal*unode(el(aktele,1),1);
        % Verbindungen von Ecken der Grundplatte zur Spitze (und zurueck)
        x_plot(6) = node(el(aktele,5),1) + ...
            defo_flag*defo_scal*unode(el(aktele,5),1);
        x_plot(7) = node(el(aktele,2),1) + ...
            defo_flag*defo_scal*unode(el(aktele,2),1);
        x_plot(8) = node(el(aktele,5),1) + ...
            defo_flag*defo_scal*unode(el(aktele,5),1);
        x_plot(9) = node(el(aktele,3),1) + ...
            defo_flag*defo_scal*unode(el(aktele,3),1);
        x_plot(10) = node(el(aktele,5),1) + ...
            defo_flag*defo_scal*unode(el(aktele,5),1);
        x_plot(11) = node(el(aktele,4),1) + ...
            defo_flag*defo_scal*unode(el(aktele,4),1);
        ...
        y_plot(5) = node(el(aktele,1),2) + ...
            defo_flag*defo_scal*unode(el(aktele,1),2);
        % Verbindungen von Ecken der Grundplatte zur Spitze (und zurueck)
        y_plot(6) = node(el(aktele,5),2) + ...
            defo_flag*defo_scal*unode(el(aktele,5),2);
        y_plot(7) = node(el(aktele,2),2) + ...
            defo_flag*defo_scal*unode(el(aktele,2),2);
        y_plot(8) = node(el(aktele,5),2) + ...
            defo_flag*defo_scal*unode(el(aktele,5),2);
        y_plot(9) = node(el(aktele,3),2) + ...
            defo_flag*defo_scal*unode(el(aktele,3),2);
        y_plot(10) = node(el(aktele,5),2) + ...
            defo_flag*defo_scal*unode(el(aktele,5),2);
        y_plot(11) = node(el(aktele,4),2) + ...
            defo_flag*defo_scal*unode(el(aktele,4),2);
        ...
        z_plot(5) = node(el(aktele,1),3) + ...
            defo_flag*defo_scal*unode(el(aktele,1),3);
        % Verbindungen von Ecken der Grundplatte zur Spitze (und zurueck)
        z_plot(6) = node(el(aktele,5),3) + ...
            defo_flag*defo_scal*unode(el(aktele,5),3);
        z_plot(7) = node(el(aktele,2),3) + ...
            defo_flag*defo_scal*unode(el(aktele,2),3);
        z_plot(8) = node(el(aktele,5),3) + ...
            defo_flag*defo_scal*unode(el(aktele,5),3);
        z_plot(9) = node(el(aktele,3),3) + ...
            defo_flag*defo_scal*unode(el(aktele,3),3);
        z_plot(10) = node(el(aktele,5),3) + ...
            defo_flag*defo_scal*unode(el(aktele,5),3);
        z_plot(11) = node(el(aktele,4),3) + ...
            defo_flag*defo_scal*unode(el(aktele,4),3);
