%Skript für Erstellen einer Displacement-Datei
clearvars;

Knotenpunkt={'Koordinatenrichtung(x=1,y=2,z=3)',...
    'Koordinatenwert in mm',...
    'Freiheitsgradrichtung(x=1,y=2,z=3) / Mehrfachauswahl möglich',...
    'Freiheitsgradwert/Verschiebung in mm',...
    'Toleranz für obigen Koordinatenwert in mm'};
Titel='Edis';
lines=1;
...
while button==0
    ...
    if temp == 1
        ...
        switch button
            case 'Ja'
                button=1;
                fprintf('Es wurden keine/keine weiteren Veränderungen an der displ.inp Datei vorgenommen');
            case 'Nein'
                button=0;
        end
    else
